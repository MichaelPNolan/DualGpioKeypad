...
#ifndef KEYPAD_MC17b_H
#define KEYPAD_MC17b_H

#include "Keypad.h"
//#include "../Wire/Wire.h"
#include "Wire.h"

class Keypad_MC17b : public Keypad {
public:
	Keypad_MC17b(char* userKeymap, byte* row, byte* col, byte numRows, byte numCols, byte address, TwoWire *_awire=&Wire ) :
